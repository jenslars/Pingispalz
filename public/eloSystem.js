...
//The user wins and this calculates elo and sends results to server.js
function player1Victory(player_1, player_2){
    ...
    //Sends result to server.js
    const xhr = new XMLHttpRequest();
    xhr.open("POST", "/submitResult");
...
//Makes it so users can't write higher numbers than 11
...
//The opponent wins and this calculates elo and sends results to server.js
